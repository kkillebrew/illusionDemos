...
[w,rect]=Screen('OpenWindow',0,[255 255 255],[0,0,2000,1000],[],[],[],100); %Be sure to set the window to the desired video size. 
...
starttime=GetSecs;
while GetSecs-starttime<.5 %Never use WaitSecs, as no frames can be collected during WaitSecs. 
...
while GetSecs-starttime<.5
    Screen('FillRect',w,[0 0 0],[xc-1,yc-5,xc+4,yc+1])
    Screen('Flip',w);
